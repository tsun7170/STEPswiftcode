...
static void yy_shift(
  ...
  if( yyTraceFILE && yypParser->yyidx>0 ){
    int i;
    fprintf(yyTraceFILE,"%sShift %d\t",yyTracePrompt,yyNewState);
...
//#line 583 "expparse.y"
{
    yygotominor.yy401 = createLITERAL_ONE();	//*TY 2020/08/26 to isolate the expression modification in later stages
}
...
//#line 663 "expparse.y"
{ 
    yygotominor.yy401 = createLITERAL_PI();	//*TY 2020/08/26 to isolate the expression modification in later stages
}
...
//#line 668 "expparse.y"
{ 
    yygotominor.yy401 = createLITERAL_E();	//*TY 2020/08/26 to isolate the expression modification in later stages
}
...
//#line 775 "expparse.y"
{
	...
	//*TY2020/08/16
	e->u.entity->type->superscope = CURRENT_SCOPE;
...
//#line 1138 "expparse.y"
{
    ...
    ALGput_full_text(CURRENT_SCOPE, yymsp[-3].minor.yy507, (int)SCANtell());
    POP_SCOPE();
}
...
{
    yygotominor.yy507 = (Integer)SCANtell();
}
...
{
    yygotominor.yy401 = createLITERAL_INFINITY();	//*TY 2020/08/26 to isolate the expression modification in later stages
}
...
{
	//*TY2020/08/25 commented out the use of shared literal, because the literal expression will be modified by rule 12
...
//#line 1548 "expparse.y"
{
    ...
    if( fabs( yymsp[0].minor.yy0.rVal ) < DBL_MIN ) {
        yygotominor.yy401 = createLITERAL_ZERO();	//*TY 2020/08/26 to isolate the expression modification in later stages
    } else {
...
//#line 1907 "expparse.y"
{
    ...
    ALGput_full_text(CURRENT_SCOPE, yymsp[-4].minor.yy507, (int)SCANtell());
    POP_SCOPE();
}
...
//    fprintf(yyTraceFILE,"%sInput %s\n",yyTracePrompt,yyTokenName[yymajor]);
		...
		bool pause = strcmp(token_text, "build_axes(")==0;
		fprintf(yyTraceFILE,"%sInput %s (%s)%s\n",yyTracePrompt,yyTokenName[yymajor], token_text,(pause?"***":""));
  }
#endif
